...
#ifndef Eigen_MXFLOAT_H_
#define Eigen_MXFLOAT_H_
...
#include "Eigen/include/float8.h"
#include "Eigen/Core"
...
template <>
struct numeric_limits<Eigen::mxfloat_internal::float6_e2m3fn>
    : public Eigen::mxfloat_internal::numeric_limits_float6_e2m3fn {};

template <>
struct numeric_limits<Eigen::mxfloat_internal::float6_e3m2fn>
    : public Eigen::mxfloat_internal::numeric_limits_float6_e3m2fn {};

template <>
struct numeric_limits<Eigen::mxfloat_internal::float4_e2m1fn>
    : public Eigen::mxfloat_internal::numeric_limits_float4_e2m1fn {};
...
MXFLOAT_EIGEN_SIGNBIT_IMPL(Eigen::float6_e2m3fn)
MXFLOAT_EIGEN_SIGNBIT_IMPL(Eigen::float6_e3m2fn)
MXFLOAT_EIGEN_SIGNBIT_IMPL(Eigen::float4_e2m1fn)
...
MXFLOAT_EIGEN_ISFINITE_IMPL(Eigen::float6_e2m3fn)
MXFLOAT_EIGEN_ISFINITE_IMPL(Eigen::float6_e3m2fn)
MXFLOAT_EIGEN_ISFINITE_IMPL(Eigen::float4_e2m1fn)
