/* Copyright 2023 The Eigen Authors
...
#ifndef Eigen_INTN_H_
#define Eigen_INTN_H_
...
template <>
struct numeric_limits<Eigen::int1>
    : public Eigen::internal::intN_numeric_limits_base<Eigen::int1> {};
template <>
struct numeric_limits<Eigen::uint1>
    : public Eigen::internal::intN_numeric_limits_base<Eigen::uint1> {};
template <>
struct numeric_limits<Eigen::int2>
    : public Eigen::internal::intN_numeric_limits_base<Eigen::int2> {};
template <>
struct numeric_limits<Eigen::uint2>
    : public Eigen::internal::intN_numeric_limits_base<Eigen::uint2> {};
template <>
struct numeric_limits<Eigen::int4>
    : public Eigen::internal::intN_numeric_limits_base<Eigen::int4> {};
template <>
struct numeric_limits<Eigen::uint4>
    : public Eigen::internal::intN_numeric_limits_base<Eigen::uint4> {};
