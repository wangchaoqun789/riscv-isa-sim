...
#ifndef Eigen_FLOAT8_H_
#define Eigen_FLOAT8_H_
...
template <>
struct numeric_limits<Eigen::float8_internal::float8_e3m4>
    : public Eigen::float8_internal::numeric_limits_float8_e3m4 {};

template <>
struct numeric_limits<Eigen::float8_internal::float8_e4m3>
    : public Eigen::float8_internal::numeric_limits_float8_e4m3 {};

template <>
struct numeric_limits<Eigen::float8_internal::float8_e4m3fn>
    : public Eigen::float8_internal::numeric_limits_float8_e4m3fn {};

template <>
struct numeric_limits<Eigen::float8_internal::float8_e4m3b11fnuz>
    : public Eigen::float8_internal::numeric_limits_float8_e4m3b11fnuz {};

template <>
struct numeric_limits<Eigen::float8_internal::float8_e4m3fnuz>
    : public Eigen::float8_internal::numeric_limits_float8_e4m3fnuz {};

template <>
struct numeric_limits<Eigen::float8_internal::float8_e5m2>
    : public Eigen::float8_internal::numeric_limits_float8_e5m2 {};

template <>
struct numeric_limits<Eigen::float8_internal::float8_e5m2fnuz>
    : public Eigen::float8_internal::numeric_limits_float8_e5m2fnuz {};

template <>
struct numeric_limits<Eigen::float8_internal::float8_e8m0fnu>
    : public Eigen::float8_internal::numeric_limits_float8_e8m0fnu {};
}  // namespace std
...
template <>
EIGEN_DEVICE_FUNC inline bool isinf_impl<Eigen::float8_e3m4>(
    const Eigen::float8_e3m4& x) {
  return Eigen::float8_internal::isinf(x);
}

template <>
EIGEN_DEVICE_FUNC inline bool isinf_impl<Eigen::float8_e4m3>(
    const Eigen::float8_e4m3& x) {
  return Eigen::float8_internal::isinf(x);
}

template <>
EIGEN_DEVICE_FUNC inline bool isinf_impl<Eigen::float8_e4m3fn>(
    const Eigen::float8_e4m3fn& x) {
  return Eigen::float8_internal::isinf(x);
}

template <>
EIGEN_DEVICE_FUNC inline bool isinf_impl<Eigen::float8_e4m3b11fnuz>(
    const Eigen::float8_e4m3b11fnuz& x) {
  return Eigen::float8_internal::isinf(x);
}

template <>
EIGEN_DEVICE_FUNC inline bool isinf_impl<Eigen::float8_e4m3fnuz>(
    const Eigen::float8_e4m3fnuz& x) {
  return Eigen::float8_internal::isinf(x);
}

template <>
EIGEN_DEVICE_FUNC inline bool isinf_impl<Eigen::float8_e5m2>(
    const Eigen::float8_e5m2& x) {
  return Eigen::float8_internal::isinf(x);
}

template <>
EIGEN_DEVICE_FUNC inline bool isinf_impl<Eigen::float8_e5m2fnuz>(
    const Eigen::float8_e5m2fnuz& x) {
  return Eigen::float8_internal::isinf(x);
}

template <>
EIGEN_DEVICE_FUNC inline bool isinf_impl<Eigen::float8_e8m0fnu>(
    const Eigen::float8_e8m0fnu& x) {
  return Eigen::float8_internal::isinf(x);
}

template <>
EIGEN_DEVICE_FUNC inline bool isnan_impl<Eigen::float8_e3m4>(
    const Eigen::float8_e3m4& x) {
  return Eigen::float8_internal::isnan(x);
}

template <>
EIGEN_DEVICE_FUNC inline bool isnan_impl<Eigen::float8_e4m3>(
    const Eigen::float8_e4m3& x) {
  return Eigen::float8_internal::isnan(x);
}

template <>
EIGEN_DEVICE_FUNC inline bool isnan_impl<Eigen::float8_e4m3fn>(
    const Eigen::float8_e4m3fn& x) {
  return Eigen::float8_internal::isnan(x);
}

template <>
EIGEN_DEVICE_FUNC inline bool isnan_impl<Eigen::float8_e4m3b11fnuz>(
    const Eigen::float8_e4m3b11fnuz& x) {
  return Eigen::float8_internal::isnan(x);
}

template <>
EIGEN_DEVICE_FUNC inline bool isnan_impl<Eigen::float8_e4m3fnuz>(
    const Eigen::float8_e4m3fnuz& x) {
  return Eigen::float8_internal::isnan(x);
}

template <>
EIGEN_DEVICE_FUNC inline bool isnan_impl<Eigen::float8_e5m2>(
    const Eigen::float8_e5m2& x) {
  return Eigen::float8_internal::isnan(x);
}

template <>
EIGEN_DEVICE_FUNC inline bool isnan_impl<Eigen::float8_e5m2fnuz>(
    const Eigen::float8_e5m2fnuz& x) {
  return Eigen::float8_internal::isnan(x);
}

template <>
EIGEN_DEVICE_FUNC inline bool isnan_impl<Eigen::float8_e8m0fnu>(
    const Eigen::float8_e8m0fnu& x) {
  return Eigen::float8_internal::isnan(x);
}

template <>
EIGEN_DEVICE_FUNC inline bool isfinite_impl<Eigen::float8_e3m4>(
    const Eigen::float8_e3m4& x) {
  return Eigen::float8_internal::isfinite(x);
}

template <>
EIGEN_DEVICE_FUNC inline bool isfinite_impl<Eigen::float8_e4m3>(
    const Eigen::float8_e4m3& x) {
  return Eigen::float8_internal::isfinite(x);
}

template <>
EIGEN_DEVICE_FUNC inline bool isfinite_impl<Eigen::float8_e4m3fn>(
    const Eigen::float8_e4m3fn& x) {
  return Eigen::float8_internal::isfinite(x);
}

template <>
EIGEN_DEVICE_FUNC inline bool isfinite_impl<Eigen::float8_e4m3b11fnuz>(
    const Eigen::float8_e4m3b11fnuz& x) {
  return Eigen::float8_internal::isfinite(x);
}

template <>
EIGEN_DEVICE_FUNC inline bool isfinite_impl<Eigen::float8_e4m3fnuz>(
    const Eigen::float8_e4m3fnuz& x) {
  return Eigen::float8_internal::isfinite(x);
}

template <>
EIGEN_DEVICE_FUNC inline bool isfinite_impl<Eigen::float8_e5m2>(
    const Eigen::float8_e5m2& x) {
  return Eigen::float8_internal::isfinite(x);
}

template <>
EIGEN_DEVICE_FUNC inline bool isfinite_impl<Eigen::float8_e5m2fnuz>(
    const Eigen::float8_e5m2fnuz& x) {
  return Eigen::float8_internal::isfinite(x);
}

template <>
EIGEN_DEVICE_FUNC inline bool isfinite_impl<Eigen::float8_e8m0fnu>(
    const Eigen::float8_e8m0fnu& x) {
  return Eigen::float8_internal::isfinite(x);
}
